...
# Training n-dimensional vectors using several models (RF, SVM, k-nearest, boost, MLP)
...
def test_model_precision(datapath):
    import getopt
    import sys 
    ...
    print 'loading data %s ...' % datapath
    samples, responses = load_base(datapath)
    Model = models['svm']
    model = Model()
...
def train(trainingdatapath, modelfilename):
    import getopt
    import sys 
    ...
    print 'loading training data %s ...' % trainingdatapath
    samples, responses = load_base(trainingdatapath)
    Model = models['svm']
    model = Model()
...
def test(testingdatapath, modelfilename):
    import getopt
    import sys
    ...
    print 'loading test data %s ...' % testingdatapath
    samples, responses = load_base(testingdatapath)
    Model = models['svm']
    model = Model()
